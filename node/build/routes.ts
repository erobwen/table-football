...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/games',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    request: {"in":"body","name":"request","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"team2Score":{"dataType":"double","required":true},"team1Score":{"dataType":"double","required":true},"team2Id":{"dataType":"double","required":true},"team1Id":{"dataType":"double","required":true},"finished":{"dataType":"boolean","required":true}}},
            };
